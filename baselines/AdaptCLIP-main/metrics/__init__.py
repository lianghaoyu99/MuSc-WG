...
def metric_collection_from_names(metric_names: List[str], prefix: Union[str, None]) -> AnomalibMetricCollection:
    ...
    Args:
        ...
        prefix (Union{str, None]): prefix to assign to the metrics in the collection.
...
def metric_collection_from_dicts(metrics: Dict[str, Dict[str, Any]], prefix: Union[str, None]) -> AnomalibMetricCollection:
