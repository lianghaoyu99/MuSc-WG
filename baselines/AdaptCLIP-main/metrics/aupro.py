...
from .pro import connected_components_cpu, connected_components_gpu
...
class AUPRO(Metric):
    ...
    higher_is_better: Union[bool, None] = None
    ...
    num_thresholds: Union[int, None]

    def __init__(
        self,
        dist_sync_on_step: bool = False,
        process_group: Union[Any, None] = None,  # noqa: ANN401
        dist_sync_fn: Union[Callable, None] = None,
        fpr_limit: float = 0.3,
        num_thresholds: Union[int, None] = None,
    ) -> None:
        super().__init__(
