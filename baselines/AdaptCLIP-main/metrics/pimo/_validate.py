...
def is_rate(rate: Union[float, int], zero_ok: bool, one_ok: bool) -> None:
...
def is_binclf_curves(binclf_curves: Tensor, valid_thresholds: Union[Tensor, None]) -> None:
...
def is_per_image_rate_curves(rate_curves: Tensor, nan_allowed: bool, decreasing: Union[bool,  None]) -> None:
