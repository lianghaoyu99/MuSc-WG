...
from torchmetrics.classification import \
    BinaryPrecisionRecallCurve as _BinaryPrecisionRecallCurve
from torchmetrics.functional.classification.precision_recall_curve import (
    _adjust_threshold_arg, _binary_precision_recall_curve_update)
...
class BinaryPrecisionRecallCurve(_BinaryPrecisionRecallCurve):
    ...
    def _binary_precision_recall_curve_format(
        preds: Tensor,
        target: Tensor,
        thresholds: Union[int, List[float], torch.Tensor, None] = None,
        ignore_index: Union[int, None] = None,
    ) -> Tuple[Tensor, Tensor, Union[torch.Tensor, None]]:
