...
test_configs = [
    ...
    # {"dataset": "microled", "path": data_root_microled, "class_name": None, "train_dataset": "mvtec"}, # Test all classes in microled
    # {"dataset": "miniled", "path": data_root_miniled, "class_name": None, "train_dataset": "mvtec"},   # Test all classes in miniled
]
