...
class PromptLearner(nn.Module):
    def __init__(self, n_ctx, n_pro, n_ctx_ab, n_pro_ab, classname, clip_model, pre):
        ...
        # Provide a default abnormal state fallback for classes not in class_state_abnormal
        class_specific_anomaly = class_state_abnormal.get(classname, ['{} with defect', '{} with anomaly', '{} with flaw'])
        state_anomaly1 = state_anomaly + class_specific_anomaly
