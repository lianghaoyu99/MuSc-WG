...
def get_dataloader_from_args(phase, **kwargs):
    if 'data_path' in kwargs and kwargs['data_path'] is not None:
        load_func = lambda category, k_shot: load_function_dict[kwargs['dataset']](category, k_shot, kwargs['data_path'])
    else:
        load_func = load_function_dict[kwargs['dataset']]
